function [ class, class_refl, rot, corr, FBsPCA_data, timing ] = Initial_classification(data, r_max, n_nbor, isrann )
...
FBsPCA_data.UU = UU;
FBsPCA_data.Freqs = Freqs;
FBsPCA_data.Coeff = Coeff;
FBsPCA_data.Mean = Mean;
FBsPCA_data.W = W;

clear U D freqs rad_freqs Mean UU W
