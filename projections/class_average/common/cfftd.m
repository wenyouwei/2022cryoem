% function y=cfftd(x)
%
% 1-D Aliased FFT of a multi-dimensional image x along dimension d.
%
...
%
% Returns the 1-D aliased FFT of the image x along dimension d.
% 
% Yoel Shkolnisky 13/1/03

function y=cfftd(x,d)
numDims = ndims(x);
s = size(x);
...
% For example, if the input array is 4x3x5 and we want to compute fft along the
