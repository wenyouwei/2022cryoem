...
fp = fopen('./abinitio/RotationEst/effectinitial3.txt','a+')
%% parameter set
for K =[ 500 1000   3000]
    fprintf(fp,'\n\nK=%4d\n',K);
    ...
    jj0 = 0;
    for pp = [  0.9    0.7   0.5   0.3   0.1] % the proportion of correctly detected common lines
        jj0 = jj0 + 1; 
        fprintf(fp,'p=%4f\n',pp);
...
%         xlabel(' Iterations', 'FontWeight',  'bold');
        ...
        %print('-dpdf',strcat('../fig/4PGDMSEplot_PP/',num2str(K),num2str(10*pp),'MES_LS'));
