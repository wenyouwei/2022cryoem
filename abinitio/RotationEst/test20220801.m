...
for SNR =  1/64   %[1  1/2  1/4  1/8  1/16  1/32]
    ...
    for j = 1:10
        ...
        [est_rots, MSE_iter, iter] = R_PG_p2q2(C, ref_rot,R_old);
        Result_LS{j} = MSE_iter;
        semilogy(MSE_iter);hold on; pause(0.1)
    end
    ...
    for j = 1:10
        ...
        [est_rots, MSE_iter, iter] = R_PG_p2q1(C, ref_rot,R_old);
        Result_LUD{j} = MSE_iter;
        semilogy(MSE_iter);hold on; pause(0.1)
    end
    ...
    for j = 1:10
        ...
        [est_rots, MSE_iter, iter] = R_PG_p2q1_20220728(C, ref_rot,R_old);
        Result_LUD1{j} = MSE_iter;
        semilogy(MSE_iter);hold on; pause(0.1)
    end
    %
    %          Result_LUD2 = {};
    %          for i = 1:10
    %          aa = Result_LUD1{i};
    %          Result_LUD2{i}= aa(1,1:600);
    %          end
    %
    %          Result_LUD1 = {};
    %          Result_LUD1 = Result_LUD2;
